"""
Django settings for masterdata project.
...
SECRET_KEY = 'django-insecure-a!c8vc5rh*@cpm-ab7!u9#s0#1d@(spa^jn@htkmei+%e@!-s9'
...
WSGI_APPLICATION = 'masterdata.wsgi.application'
